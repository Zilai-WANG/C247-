...
def load_data(data_path, subjects=[1,2,3,4,5,6,7,8,9], verbose=False):
    ...
    # suitable for dealing with length-variable dataset
    ...
    # data aggregation from different subjects
    for s in subjects:
        ...
        # concatenate subject-specific EEG data ; useful when comparing subjects
...
# filter the noise in each channel
